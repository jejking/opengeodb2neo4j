...
public class PlaceNodeMapper {
    ...
    /**
     * Property names corresponding for a given subset of the properties
     * in a line of the tab-delimited file. Postal codes and hierarchical
     * containment are (obviously) not mapped as node properties but as
     * relationships. 
     */
	...
	LEVEL,
	/**
	 * Some indication of validity - 1 meaning "invalid", 0 meaning "valid" and its
	 * absence also indicating validity.
	 */
	INVALID;
    }
    
    /**
     * Creates the node for a place. Properties are mapped across. The OpenGeoDb ID
     * and the name are indexed.
     * 
     * @param graphDb the graph db service
     * @param nodeIndex a node index
     * @param placeBean the place for which to create a node

...
public class PlaceNodeMapperTest extends AbstractGraphDbTest {
	...
	assertEquals(this.placeNode.getProperty(PlaceNodeMapper.PlaceNodeProperties.TYPE.name()), "Freie und Hansestadt");
	...
	IndexHits<Node> foundByLocId = this.nodeIndex.query(PlaceNodeMapper.PlaceNodeProperties.LOC_ID.name(), Integer.valueOf(17838));
